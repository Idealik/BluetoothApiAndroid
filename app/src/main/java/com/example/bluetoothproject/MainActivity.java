...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendData(String message) {
        ...
        Log.d(TAG, "sendData: " + msgBuffer);
        byte[] msgBuffer2 = stringToBytesUTFCustom(message);
        Log.d(TAG, "sendData: " + msgBuffer2);
        Log.d(TAG, "...Посылаем данные: " + message + "...");

        Log.d(TAG, "REVERSE: " + bytesToStringUTFCustom(msgBuffer));
        Log.d(TAG, "REVERSE: " + bytesToStringUTFCustom(msgBuffer2));
